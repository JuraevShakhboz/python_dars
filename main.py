...
class AuthPage(QWidget):
    def __init__(self):
        ...
        self.loginTitle.setStyleSheet("color:red; font-size: 15px")
        ...
        self.userNameEdit.setStyleSheet("background-color:#F6CEFC")
        ...
        self.passwordEdit.setStyleSheet("background-color:#F6CEFC")
